...
build:
	forge build
deploy-sepolia:
	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA_RPC_URL) --account Acc2 --froms 0xddb3e95fe154b1a1457c461cbdd48cb68bfb8944 --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
